      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">REGISTRO DE COMIDAS</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="./crearComid.php" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nombre" class="form-control" id="inputPelicula" placeholder="Nombre del combo">
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="registrar" class="btn btn-info">Registrar comida</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabla de comidas</h3>
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td><img class="comidas" src="<?php echo $row['img'];?>"/></td>
        ...
        <form method="POST" action="./eliminarComid.php">
        <br/><br/>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">MODIFICAR DATOS DE COMIDAS</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="./actualizarComid.php" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body">
                <div class="form-group row">
                    <label for="inputId" class="col-sm-2 col-form-label">Identificacion</label>
                    <div class="col-sm-10">
